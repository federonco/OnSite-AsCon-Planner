        ...
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <label className="flex flex-wrap items-center gap-2 text-dashboard-sm text-dashboard-text-secondary">
            ...
            <input
              ...
              className="rounded-dashboard-md border border-dashboard-border bg-dashboard-bg px-3 py-1.5 text-dashboard-sm text-dashboard-text-primary transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-dashboard-primary/30"
            />
            <button
              type="button"
              onClick={() => onDateChange(todayYmd())}
              className="rounded-dashboard-md border border-dashboard-border px-3 py-1.5 text-dashboard-xs font-medium text-dashboard-text-secondary transition-colors hover:bg-dashboard-bg"
            >
              Today
            </button>
          </label>
